...
{
    public class IngestWebClient : WebClient
    {
        private static readonly Random Rng = new();
        private readonly bool _randomUserAgent;
        private readonly string _userAgent;

        public IngestWebClient(bool randomUserAgent = false, string userAgent = null)
        {
            _randomUserAgent = randomUserAgent;
        ...
        protected override WebRequest GetWebRequest(Uri address)
        {
            ...
            if (request != null)
            {
                var userAgent = _randomUserAgent
                    ? GetRandomUserAgent()
        ...
        {
            return CommonUserAgents[Rng.Next(CommonUserAgents.Length)];
        }

        public const string DefaultUserAgent =
            "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.101 Safari/537.36";

        private static readonly string[] CommonUserAgents =
        {
